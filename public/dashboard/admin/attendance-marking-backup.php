                ...
                <div class="mb-6">
                    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between">
                        ...
                        <div class="mt-4 sm:mt-0 flex flex-col sm:flex-row gap-3">
                            ...
                            <!-- Debug: Test button -->
                            <button onclick="console.log('Test button works!'); alert('QR Toggle Test'); toggleQRScanner();"
                                class="inline-flex items-center px-2 py-1 bg-blue-500 text-white rounded text-xs">
                                Test
                            </button>
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            document.addEventListener('keydown', function(event) {
                ...
                console.log('Key pressed:', event.key, 'Target:', event.target.tagName);
                
                if (event.target.tagName !== 'INPUT' && event.target.tagName !== 'TEXTAREA' && event.target.tagName !== 'SELECT') {
                    switch(event.key) {
                        case ' ': // Spacebar to toggle QR scanner
                            event.preventDefault();
                            console.log('Space key pressed - toggling QR scanner');
                            toggleQRScanner();
                            break;
        ...
        function toggleQRScanner() {
            console.log('toggleQRScanner called');
            const qrSection = document.getElementById('qrScannerSection');
            ...
            console.log('QR Section current classes:', qrSection.className);
            
            if (qrSection.classList.contains('hidden')) {
                qrSection.classList.remove('hidden');
                console.log('QR Scanner section shown');
            } else {
                qrSection.classList.add('hidden');
                console.log('QR Scanner section hidden');
            }
        }
